...
// const createSearchBar = require('search_bar')
...
async function contacts_list (opts = {}) {
  ...
  // const containerEl2 = shadow.querySelector('.search-bar-container')
  ...
  async function renderContacts(contactList) {
    ...
    // containerEl2.innerHTML = `<div class="contact-list-header">Contacts</div>`
    // const search_bar = await createSearchBar(contact)

    // containerEl2.appendChild(search_bar)
